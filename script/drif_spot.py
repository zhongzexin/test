...
class ESPOT:
    ...
    def initialize(self, verbose=True):
        ...
        self.init_threshold['up'] = S[int(0.99 * n_init)]  # t is fixed for the whole algorithm
        self.init_threshold['down'] = S[int(0.01 * n_init)]  # t is fixed for the whole algorithm
    ...
    def plot(self, run_results, with_alarm=True):
        ...
        plt.legend(handles=[ts_fig, lth_fig], labels=['Actual', 'Threshold'])
        plt.show()
